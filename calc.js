...
// Add the numbers on the display
function appendToDisplay(input) {
	display.value += input;
}
// Clear the display screen and reset it back to empty
...
document.addEventListener("keydown", (input) => {
	...
	// Test the keys that are pressed to make sure its only the ones stored in the string expression in the allowedNum variable
